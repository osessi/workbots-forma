...
class TemplateCreateRequest(BaseModel):
    ...
    pptx_template_id: Optional[UUID] = None  # Link to original PPTX for high-quality export
    ...
    try:
        ...
        if template_meta:
            template = {
                ...
                "pptx_template_id": str(template_meta.pptx_template_id) if template_meta.pptx_template_id else None,
...
async def create_template(
    ...
    try:
        ...
        if existing:
            ...
            if request.pptx_template_id:
                existing.pptx_template_id = request.pptx_template_id
        else:
            session.add(
                TemplateModel(
                    id=request.id,
        ...
        return TemplateCreateResponse(
            ...
            template={
                ...
                "pptx_template_id": template.pptx_template_id,
