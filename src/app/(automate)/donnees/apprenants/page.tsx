  ...
  useEffect(() => {
    if (editIdFromUrl && apprenants.length > 0 && !isModalOpen) {
      ...
      if (apprenantToEdit) {
        ...
        setFormData({
          nom: apprenantToEdit.nom,
          prenom: apprenantToEdit.prenom,
          email: apprenantToEdit.email,
          telephone: apprenantToEdit.telephone || "",
          raisonSociale: apprenantToEdit.raisonSociale || "",
          siret: apprenantToEdit.siret || "",
          adresse: apprenantToEdit.adresse || "",
          codePostal: apprenantToEdit.codePostal || "",
          ville: apprenantToEdit.ville || "",
          pays: apprenantToEdit.pays || "France",
          statut: apprenantToEdit.statut,
          situationActuelle: apprenantToEdit.situationActuelle || "",
          entrepriseId: apprenantToEdit.entrepriseId || "",
          notes: apprenantToEdit.notes || "",
        });
            ...
            <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-800 rounded-lg">
              ...
              <button
                onClick={() => {
                  ...
                  // Nettoyer l'URL
                  window.history.replaceState({}, "", "/donnees/apprenants");
                }}
