...
// ===========================================
// PAGE HISTORIQUE EMAILS - Traçabilité Qualiopi
// ===========================================
...
import {
  ...
  FileText, Calendar, ChevronLeft, ChevronRight, Download, ArrowLeft
} from "lucide-react";
...
const EMAIL_TYPES = {
  ...
  NEWSLETTER: { label: "Newsletter", color: "bg-pink-100 text-pink-700 dark:bg-pink-900/30 dark:text-pink-400", icon: Mail },
  CUSTOM: { label: "Personnalisé", color: "bg-brand-100 text-brand-700 dark:bg-brand-900/30 dark:text-brand-400", icon: Send },
...
export default function HistoriqueEmailsPage() {
  ...
  // Correction 556: Fonctions séparées pour date et heure
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            ...
            {/* Correction 551: Sous-titre reformulé */}
            <p className="text-gray-500 dark:text-gray-400 mt-1">
              Retrouvez ici l&apos;historique et le suivi des emails envoyés depuis la plateforme.
            </p>
          </div>
          <button
          ...
          <div className="flex flex-wrap gap-4 items-center">
            <div className="flex-1 min-w-[250px]">
              <div className="relative">
                ...
                {/* Correction 552: Placeholder reformulé */}
                <input
                  type="text"
                  placeholder="Rechercher par destinataire, objet ou email…"
                  value={search}
            ...
            <table className="w-full">
              <thead className="bg-gray-50 dark:bg-gray-900/50">
                <tr>
                  ...
                  {/* Correction 555: Libellé renommé */}
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                    Objet
                  </th>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  ...
                  {/* Correction 556: Date et Heure séparées */}
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                    Date
                  </th>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                {/* Correction 556: colSpan ajusté à 7 colonnes */}
                {loading ? (
                  <tr>
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <p className="text-sm text-gray-500 dark:text-gray-400 flex items-center gap-1">
                            ...
                            {formatDateOnly(email.sentAt)}
                          </p>
                        </td>
                        <td className="px-4 py-3">
                          <p className="text-sm text-gray-500 dark:text-gray-400 flex items-center gap-1">
                            <Clock className="w-3 h-3" />
                            {formatTimeOnly(email.sentAt)}
                          </p>
                        </td>
