...
const tabs: { id: TabType; label: string; icon: React.ReactNode }[] = [
  ...
  // TODO: Réactiver quand les fonctionnalités équipe/rôles/invitations seront prêtes
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">
                  <Link href="/settings?tab=billing" className="text-brand-500 hover:text-brand-600">
...
function IntegrationsTab() {
  ...
  // Configuration des providers avec couleurs douces et moins agressives
  const providerConfig: Record<string, {
    ...
    ZOOM: {
      ...
      disabledBg: "bg-blue-100 dark:bg-blue-900/20",
      iconBg: "bg-blue-100 dark:bg-blue-900/30",
    },
    GOOGLE_MEET: {
      bgColor: "bg-emerald-500/80",
      hoverColor: "hover:bg-emerald-500/90",
      disabledBg: "bg-emerald-100 dark:bg-emerald-900/20",
      iconBg: "bg-emerald-100 dark:bg-emerald-900/30",
    },
    MICROSOFT_TEAMS: {
      bgColor: "bg-violet-500/80",
      hoverColor: "hover:bg-violet-500/90",
      disabledBg: "bg-violet-100 dark:bg-violet-900/20",
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {providers.map((provider) => {
          ...
          // Logos officiels inline - blanc si configuré, couleur marque douce si non configuré
          const renderLogo = () => {
            const fillColor = isConfigured ? "white" : (
              provider.id === "ZOOM" ? "#3B82F6"
              : provider.id === "GOOGLE_MEET" ? "#10B981"
              : "#8B5CF6"
            );
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <span className={`font-medium ${
                      isConfigured
                        ? "text-white"
                        : provider.id === "ZOOM" ? "text-blue-600 dark:text-blue-400"
                        : provider.id === "GOOGLE_MEET" ? "text-emerald-600 dark:text-emerald-400"
                    ...
                    {!isConfigured && (
                      <p className={`text-xs mt-0.5 ${
                        provider.id === "ZOOM" ? "text-blue-500/60 dark:text-blue-400/60"
                        : provider.id === "GOOGLE_MEET" ? "text-emerald-500/60 dark:text-emerald-400/60"
