...
import { Card, CardContent, CardHeader, CardTitle } from "@/components/slides/ui/card";
...
const EachSlide: React.FC<EachSlideProps> = ({
  ...
  const handleSaveWithDrawing = () => {
    if (slideDisplayRef.current) {
      handleSave(slideDisplayRef as React.RefObject<HTMLDivElement>, didYourDraw);
    }
  };
