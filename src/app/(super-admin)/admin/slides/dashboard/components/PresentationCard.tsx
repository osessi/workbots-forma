...
import { DashboardApi } from "@/app/(super-admin)/admin/slides/services/api/dashboard";
...
import { useTemplateLayouts } from "@/app/(super-admin)/admin/slides/hooks/useTemplateLayouts";
...
export const PresentationCard = ({
  ...
  const handlePreview = (e: React.MouseEvent) => {
    e.preventDefault();
    router.push(`/admin/slides/presentation?id=${id}`);
  };
