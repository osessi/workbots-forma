...
import { Skeleton } from "@/components/slides/ui/skeleton";
import { OverlayLoader } from "@/components/slides/ui/overlay-loader";
import { PresentationGenerationApi } from "../../services/api/presentation-generation";
import { setPresentationId } from "@/store/slides-store/slices/presentationGeneration";
...
import Header from "@/app/(super-admin)/admin/slides/dashboard/components/Header";
...
const DocumentsPreviewPage: React.FC = () => {
  ...
  const handleCreatePresentation = async () => {
    try {
      ...
      router.replace("/admin/slides/outline");
    } catch (error: any) {
