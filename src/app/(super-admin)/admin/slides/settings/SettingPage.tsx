...
import { handleSaveLLMConfig } from "@/utils/slides/storeHelpers";
import {
  checkIfSelectedOllamaModelIsPulled,
  pullOllamaModel,
} from "@/utils/slides/providerUtils";
import { useRouter, usePathname } from "next/navigation";
import LLMProviderSelection from "@/components/slides/LLMSelection";
...
const SettingsPage = () => {
  ...
  const handleSaveConfig = async () => {
    ...
    try {
      ...
      router.push("/admin/slides/upload");
    } catch (error) {
  ...
  useEffect(() => {
    if (!canChangeKeys) {
      router.push("/admin/slides/dashboard");
    }
