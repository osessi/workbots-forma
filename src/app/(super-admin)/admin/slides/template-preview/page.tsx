...
const LayoutPreview = () => {
  ...
  useEffect(() => {
    ...
    fetch(`/api/slides/v1/ppt/template-management/summary`, {
      headers: getHeader(),
    })
      .then((res) => res.json())
      .then((data) => {
          ...
          <div className="max-w-7xl mx-auto px-6 py-6 w-full">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="text-sm text-gray-800 hover:text-blue-600 transition-colors flex items-center gap-2 group" onClick={() => {
                ...
                router.push(`/admin/slides/custom-template`)
              }}>
                  ...
                  return (
                    <Card
                      ...
                      onClick={() => {
                        ...
                        router.push(`/admin/slides/template-preview/${template.templateID}`)
                      }}
                    >
                      <div className="p-6">
