...
import { clearOutlines, setPresentationId } from "@/store/slides-store/slices/presentationGeneration";
...
import { setPptGenUploadState } from "@/store/slides-store/slices/presentationGenUpload";
...
const UploadPage = () => {
  ...
  const handleDocumentProcessing = async () => {
    ...
    router.push("/admin/slides/documents-preview");
  };
  ...
  const handleDirectPresentationGeneration = async () => {
    ...
    router.push("/admin/slides/outline");
  };
