...
// Stockage temporaire de la configuration en mémoire (en production, utiliser une base de données)
// Pour l'instant, on retourne la config depuis .env avec les modèles par défaut
