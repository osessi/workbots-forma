    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03] card-hover-glow">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="border-2 border-gray-100 dark:border-gray-700 ring-2 ring-transparent hover:ring-brand-100 dark:hover:ring-brand-500/20 transition-all rounded-full">
            <UserAvatar
              src={user.avatarUrl}
